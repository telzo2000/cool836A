...
<<<<<<< HEAD
□Bluetooth採用<br>
☑︎BLE micro使用時の電池ケース収納部分を追加（2020/11/11）<br>
=======
□Bluetooth採用　※よくわかっていませんが、イエローバージョンまでならば、多分電池を収納するスペースがあるだろうと考えました。思いつきです。青色にして「ブルーバージョン」となるかな。<br>
>>>>>>> 7bc96b94bc827a58c976fded1ec025a91e158e12

# 発注ガーバーファイル名
試作　gbr　（20200812）<br>
Ver.A gbr20200901　通称「ブラックバージョン」<br>
Ver.B+ gbr20201025　通称「レッドバージョン」<br>
Ver.C+　通称「イエローバージョン（仮）」<br>
